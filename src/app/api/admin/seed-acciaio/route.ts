...
import prodottiData from "../../../../../prisma/seed-data/acciaio_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/acciaio_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/acciaio_optional.json";
...
const TIPOLOGIE_PREFIXES = ["ACCIAIO_"];
const LISTINO_OPTIONAL = "ACCIAIO";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const optionaliEsistenti = await prisma.optional.findMany({
      where: { brandId: brand.id, listino: LISTINO_OPTIONAL },
    });
