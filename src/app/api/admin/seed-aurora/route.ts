...
import prodottiData from "../../../../../prisma/seed-data/aurora_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/aurora_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/aurora_optional.json";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prodottiEsistenti = await prisma.prodotto.findMany({
      where: { brandId: brand.id, tipologia: { startsWith: "ISCHIA_" } },
    });
    ...
    const optionaliEsistenti = await prisma.optional.findMany({ where: { brandId: brand.id, listino: "AURORA" } });
