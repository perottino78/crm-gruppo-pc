...
import prodottiData from "../../../../../prisma/seed-data/beachwave_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/beachwave_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/beachwave_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "GAZEBI BEACH WAVE";
...
const TIPOLOGIE_PREFIXES = ["BEACHWAVE_"];
