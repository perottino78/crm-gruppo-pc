...
import prodottiData from "../../../../../prisma/seed-data/braccicassonetto_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/braccicassonetto_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/braccicassonetto_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "TENDE A BRACCI CON CASSONETTO";
