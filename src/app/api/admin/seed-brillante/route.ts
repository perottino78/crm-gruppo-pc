...
import prodottiData from "../../../../../prisma/seed-data/brillante_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/brillante_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/brillante_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "VETRATE BRILLANTE";
...
const TIPOLOGIE_PREFIXES = ["VETRATA_BRILLANTE"];
