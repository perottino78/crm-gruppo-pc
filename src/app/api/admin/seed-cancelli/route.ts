...
import prodottiData from "../../../../../prisma/seed-data/cancelli_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/cancelli_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/cancelli_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "CANCELLI";
...
const TIPOLOGIE_PREFIXES = ["CANCELLI_"];
