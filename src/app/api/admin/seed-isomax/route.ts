...
import prodottiData from "../../../../../prisma/seed-data/isomax_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/isomax_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/isomax_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "PORTE INTERNE";
...
const TIPOLOGIE_PREFIXES = ["ISOMAX_", "PORTEPC_"];
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const optionaliDaRimuovere = optionaliEsistenti.filter((o) => !chiaviOptNuove.has(keyOptional(o)));
    let optRimossi = 0;
