...
import prodottiData from "../../../../../prisma/seed-data/lamborghini_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/lamborghini_modelli.json";
...
// Lamborghini CaloreClima (Solaris): catalogo fornitore importato con famiglie/gruppi
// merceologici ma senza prezzi reali (da definire in seguito). Ogni riga è un articolo
// a listino "placeholder" (prezzoBase 0, senza misura, altezzaMm/larghezzaMm = 0),
// raggruppato per tipologia (SOLARIS_<slug modello>) con il nome commerciale nel campo
// "colore" — stesso pattern già usato per Motori e Automatismi (Cherubini).
...
const TIPOLOGIA_PREFIX = "SOLARIS_";
