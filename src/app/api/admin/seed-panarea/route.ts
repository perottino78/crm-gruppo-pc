...
import prodottiData from "../../../../../prisma/seed-data/panarea_prodotti.json";
import optionaliData from "../../../../../prisma/seed-data/panarea_optionals.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const PREFISSO = "PANAREA_";
const LISTINO_FAMIGLIA = "PANAREA";
