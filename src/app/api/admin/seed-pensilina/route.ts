...
import prodottiData from "../../../../../prisma/seed-data/pensilina_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/pensilina_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/pensilina_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "PENSILINE";
...
const TIPOLOGIE_PREFIXES = ["PENSILINA_"];
