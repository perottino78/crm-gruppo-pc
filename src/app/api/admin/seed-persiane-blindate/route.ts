...
import prodottiData from "../../../../../prisma/seed-data/persiane_blindate_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/persiane_blindate_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/persiane_blindate_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "PERSIANE";
...
const TIPOLOGIE_PREFIXES = ["PERSIANEBLINDATE_"];
