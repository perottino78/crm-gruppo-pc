...
import prodottiData from "../../../../../prisma/seed-data/plisse_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/plisse_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/plisse_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "ZANZARIERE_PLISSE";
