...
import prodottiData from "../../../../../prisma/seed-data/scintilla_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/scintilla_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/scintilla_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "VETRATE SCINTILLA";
...
const TIPOLOGIE_PREFIXES = ["VETRATA_SCINTILLA"];
