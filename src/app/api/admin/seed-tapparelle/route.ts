...
import prodottiData from "../../../../../prisma/seed-data/tapparelle_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/tapparelle_modelli.json";
...
const TIPOLOGIE_PREFIXES = ["TAPPARELLE_"];
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Rimuove eventuali optional dello scope Tapparelle non piu' presenti nel JSON,
    // cosi' il seed resta sincronizzato col file invece di lasciare righe orfane in DB.
