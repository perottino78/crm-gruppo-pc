...
const TIPOLOGIE_GESTITE = [
  ...
  "TENDACADUTA_ORIZZONTE_ROUND",
  "TENDACADUTA_ORIZZONTE_SQUARE",
  "TENDACADUTA_T4_ROUND",
  "TENDACADUTA_T4_SENZACASS",
];

// Listini usati dagli Optional per lo scoping (solo le 19 famiglie non-Ombra;
