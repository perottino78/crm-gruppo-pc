...
import prodottiData from "../../../../../prisma/seed-data/veneziane_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/veneziane_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/veneziane_optional.json";

export const dynamic = "force-dynamic";

const SECRET = process.env.SEED_SECRET || "gpc-2026-seed-x7f2";
const BRAND = "P&C";
const GRUPPO = "VENEZIANE ESTERNO";
...
const TIPOLOGIE_PREFIXES = ["VENEZIANA_"];
