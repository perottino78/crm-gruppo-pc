...
import prodottiData from "../../../../../prisma/seed-data/wawe_prodotti.json";
import modelliData from "../../../../../prisma/seed-data/wawe_modelli.json";
import optionaliData from "../../../../../prisma/seed-data/wawe_optional.json";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prodottiEsistenti = await prisma.prodotto.findMany({
      where: { brandId: brand.id, tipologia: { startsWith: "WAWE_" } },
    });
    ...
    const optionaliEsistenti = await prisma.optional.findMany({ where: { brandId: brand.id, listino: "WAWE" } });
