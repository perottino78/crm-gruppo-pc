...
export default async function CommercialiPage() {
  ...
  return (
    <div className="max-w-5xl">
      <h1 className="text-xl font-medium mb-6">Team &amp; performance</h1>
      ...
      <div className="bg-white rounded-lg border border-neutral-200 overflow-hidden">
              ...
              return (
                <tr key={u.id}>
                  <td className="px-4 py-2 font-medium">
                    ...
                    <span className="block text-xs text-neutral-400 font-normal">{u.email}</span>
                  </td>
        ...
        {utenti.length === 0 && <p className="px-4 py-6 text-sm text-neutral-400">Nessun utente ancora.</p>}
      </div>
    </div>
  );
}
